...
class Forms extends Component{
    ...
    render() {
        const {modalShowMember, modalShowProject, modalShowFaq, modalShowPolygon} = this.state;
                            ...
                            <div align="center">
                                <Form>
                                    ...
                                    <Form.Group>
                                        <>
                                        {/* Modal Q&A */}
                                        <Button variant="success" onClick={() => this.setModalShowFAQ(true)}>
                                            Modal Saiba Mais
                                        </Button>
                                        ...
                                        <Modal show={modalShowFaq}>
                                            ...
                                            <Modal.Footer>
                                            <Button variant="primary" onClick={() => this.setModalShowFAQ(false)}>
                                                Save Changes
                                            </Button>
                                            </Modal.Footer>
                                        </Modal>
                                        {/* ModalPolygon */}
                                        <Button variant="success" onClick={() => this.setModalShowPolygon(true)}>
                                            Modal Polygon
                                        </Button>
                                        ...
                                        <Modal show={modalShowPolygon}>
                                            ...
                                            <Modal.Footer>
                                            <Button variant="primary" onClick={() => this.setModalShowPolygon(false)}>
                                                Save Changes
                                            </Button>
                                            </Modal.Footer>
                                        </Modal>
