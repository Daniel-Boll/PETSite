                ...
                >
                  <Container>
                    ...
                    <div style={{ maxWidth: "300px" }} align="left">
                      ...
                      <p style={{ color: "white" }}>
                        O PET Ciência da Computação (PETComp) foi criado em
                        dezembro de 2010 e é o 5º Grupo PET da UNIOESTE (1º do
                        campus de Cascavel), destinado exclusivamente aos alunos
                        regularmente matriculados no Curso. Sua aprovação junto
                        ao MEC foi uma conquista do Prof. Dr. Clodis Boscarioli,
                        muito bem recebida, após 5 tentativas de submissão de
                        projeto por parte de vários professores.
                      </p>
                    </div>
                  </Container>
                </Zoom>
                  ...
                  >
                    ...
                    <div align="center">
                      <a
                        ...
                        href="https://pngtree.com/so/página-de-reunião"
                      >
                        página-de-reunião png from pngtree.com
                      </a>
                    </div>
                  </Container>
                </Zoom>
                    ...
                    <div align="center">
                      <div style={{ maxWidth: "300px" }} align="left">
                        ...
                        <p style={{ color: "white" }}>
                          ...
                          devem ter um projeto de iniciação cientifica.
                        </p>
                      </div>
                    </div>
                  </Container>
                  ...
                  <Container>
                    <div style={{ maxWidth: "300px" }} align="left">
                      ...
                      <p style={{ color: "white" }}>
                        ...
                        conhecimento, como minicursos e palestras, que são
                        abertos para os membros do PET e para os acadêmicos do
                  ...
                  <Container>
                    <div style={{ maxWidth: "300px" }} align="left">
                      ...
                      <p style={{ color: "white" }}>
                        ...
                        de extensão, que estabelecem uma conexão com a
                        comunidade.
                      </p>
                    </div>
                  </Container>
